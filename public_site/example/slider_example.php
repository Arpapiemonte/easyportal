...
<head>
	<meta charset="utf-8">
	<title>Auto Center with No Scale Example - Jssor Slider</title>
</head>
...
<body>
	...
	<div style="position:relative;top:0;left:0;width:100%;overflow:hidden;">
		...
		<div id="slider1_container"
			style="position: relative; margin: 0 auto; top: 0px; left: 0px; width: 980px; height: 380px;">
			<!-- Loading Screen -->
			...
			<!-- Slides Container -->
			<div data-u="slides"
				style="cursor: move; position: absolute; left: 0px; top: 0px; width: 980px;  height: 380px; overflow: hidden;">
				<div>
					<img data-u="image" src="/public_site/example/img/gallery/980x380/011.jpg" />
				</div>
				<div>
					<img data-u="image" src="/public_site/example/img/gallery/980x380/002.jpg" />
				</div>
				<div>
					<img data-u="image" src="/public_site/example/img/gallery/980x380/003.jpg" />
				</div>
				<div>
					<img data-u="image" src="/public_site/example/img/gallery/980x380/004.jpg" />
				</div>
				<div>
					<img data-u="image" src="/public_site/example/img/gallery/980x380/005.jpg" />
				</div>
				<div>
					<img data-u="image" src="/public_site/example/img/gallery/980x380/006.jpg" />
				</div>
			</div>
